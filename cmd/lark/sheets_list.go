...
func newSheetsListCmd(state *appState) *cobra.Command {
	var folderID string
	var limit int

	cmd := &cobra.Command{
		Use:   "list",
		Short: "List Sheets (spreadsheets) in a Drive folder",
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			for {
				...
				// Thin wrapper over drive list: fetch then filter to sheet.
