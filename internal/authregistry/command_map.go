...
var commandServiceMap = map[string][]string{
	...
	"drive share":                {"drive-permissions"},
	"drive permissions":          {"drive-permissions"},
	"drive comment":              {"drive-comment-read"},
	"drive comment add":          {"drive-comment-write"},
	"drive comment update":       {"drive-comment-write"},
	"drive comment reply":        {"drive-comment-write"},
	"drive comment reply-update": {"drive-comment-write"},
